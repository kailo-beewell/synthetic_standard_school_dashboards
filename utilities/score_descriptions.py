...
score_descriptions = {
    ...
    'stress': ['0 to 16', 'that pupils are feeling lower levels of stress, and better able to cope with stress'],
    ...
    'support': ['2 to 8', 'pupils feel more able to support themselves when feeling down'],
    'sleep': ['0 to 1', 'pupils feel they get enough sleep'],
    'physical': ['0 to 840', 'higher levels of physical activity'],
    'free_like': ['1 to 5', 'pupils feel that they are more often able to do things that they like in their free time'],
    'media': ['0 to 8', 'less time spent on social media'],
    'places': ['1 to 4', 'pupils feel there are activities/places in their local area that they would choose to or want to go to'],
    'talk': ['3 to 12', 'pupils feel more positively about talking with others when feeling down'],
    'accept': ['4 to 16', 'higher levels of perceived acceptance by others'],
    'school_belong': ['1 to 5', 'higher levels of school connection'],
    'staff_relationship': ['4 to 20', 'higher levels of perceived support from staff'],
    ...
    'climate': ['1 to 4', 'lower levels of worrying about the impact of climate change on their future'],
